...
image_datasets = {x: datasets.ImageFolder(os.path.join(data_dir, x))
                  for x in ['shoes 2steps']}
dataset_len = len(image_datasets['shoes 2steps'])


class_names = image_datasets['shoes 2steps'].classes

image_datasets['val'], image_datasets['train'] = random_split(image_datasets['shoes 2steps'], [dataset_len // 5,
...
namefile=open('class_name_shoes.py','w')
namefile.write('class_names_shoes=[')
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model.state_dict(), 'trained_nn_shoes')
