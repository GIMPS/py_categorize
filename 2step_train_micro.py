...
data_dir = '2step data micro'
image_datasets = {x: datasets.ImageFolder(os.path.join(data_dir, x))
                  for x in ['Training Images 2steps']}
dataset_len = len(image_datasets['Training Images 2steps'])


class_names = image_datasets['Training Images 2steps'].classes

image_datasets['val'], image_datasets['train'] = random_split(image_datasets['Training Images 2steps'], [dataset_len // 5,
...
namefile=open('class_name_general.py','w')
namefile.write('class_names_general=[')
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model.state_dict(), 'trained_nn_general')
